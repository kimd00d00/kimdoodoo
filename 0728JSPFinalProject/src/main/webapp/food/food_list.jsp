...
<body>
	<div class="wrapper row3">
	  <main class="container clear">
	  	<div class="jumbotron">
	  		<h3 class="text-center" style="color:black;">${vo.title }</h3>
	  					...
	  					<c:forEach var="fvo" items="${list }">
	  						<table class="table">
	  							<tr>
	  								...
	  								<td width="70%">
	  									<a href="../food/food_detail_before.do?fno=${fvo.fno }"><h4>${fvo.name }&nbsp;<span style="color:orange">${fvo.score }</span></h4></a>
	  								</td>
	  							</tr>
	  							<tr>
