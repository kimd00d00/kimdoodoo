...
<body>
	...
	<form method=post action="../adminpage/reply_insert_ok.do" id="frm"> <!-- dispatcherServlet으로 보내겠다 -->
     	<table class="table">
     		<tr>
     		...
     		<tr>
     			<td colspan="2" class="text-center">
     				<input type="submit" value="등록" class="btn btn-sm btn-success" id="writeBtn">
