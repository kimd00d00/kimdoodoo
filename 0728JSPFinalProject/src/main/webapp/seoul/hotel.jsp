          ...
          <ul class="nospace clear">
          	<c:forEach var="vo" items="${list }" varStatus="s">
          		<c:if test="${s.index%4==0 }">
          			<li class="one_quarter first"><a href="#"><img src="${vo.poster }" title="${vo.title }" alt="" style="width:230px; height:150px;"></a></li>
          		</c:if>
          		<c:if test="${s.index%4!=0 }">
          			<li class="one_quarter"><a href="#"><img src="${vo.poster }" title="${vo.title }" alt="" style="width:230px; height:150px;"></a></li>
          		</c:if>
            </c:forEach>
          </ul>
