			...
			<table class="table">
				<tr>
					...
					<td width="85%">
						...
						<%-- <a href="reply.jsp?pno=${vo.no }">로 보내준 pno받기 --%>
						<%-- request.getParameter("pno") 로 받는 것과 동일함↓↓ --%>
						<input type=hidden name="pno" value="${param.pno }"> <%-- no는 숨기기 --%>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="text-center">
						<button class="btn btn-sm btn-danger">답변달기</button>
